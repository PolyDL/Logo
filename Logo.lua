...
markgrandient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(144, 218, 252)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 255))}
markgrandient.Parent = mainmark
local uidmark = mainmark:Clone()
uidmark.Text = "Version 5.2 | Owner Variation"
...
infolabel.Text = "Made By CLOUD Owner"
