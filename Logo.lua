...
mainmark.Font = Enum.Font.GothamBlack
mainmark.Parent = WatermarkGui
local markgrandient = Instance.new("UIGradient")
markgrandient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(173, 225, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(230, 246, 255))}
markgrandient.Parent = mainmark
local uidmark = mainmark:Clone()
uidmark.Text = "Version 18.23X | Owner Version"
...
infolabel.Text = "Made by Poly#1337"
